...
namespace Study {
	...
	class STUDY_API InstrumentationTimer
	{
	public:
...
#define STUDY_PROFILE 1
	...
	#define STUDY_PROFILE_BEGIN_SESSION(name, filepath) ::Study::Instrumentor::Get().BeginSession(name, filepath)
	#define STUDY_PROFILE_END_SESSION() ::Study::Instrumentor::Get().EndSession()
	#define STUDY_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Study::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::Study::InstrumentationTimer timer##line(fixedName##line.Data)
