...
void OpenGLFramebuffer::Invalidate()
{
    ...
    {
        STUDY_CORE_ASSERT(m_ColorAttachments.size() <=4, " ");
    ...
    STUDY_CORE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Invalid framebuffer");
...
int OpenGLFramebuffer::ReadPixel(uint32_t attachmenteIndex, int x, int y)
{

    STUDY_CORE_ASSERT(attachmenteIndex < m_ColorAttachments.size(), " ");
    glReadBuffer(GL_COLOR_ATTACHMENT0 + attachmenteIndex);
    int pixelData;
